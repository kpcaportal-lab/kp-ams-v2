...
import {
  ...
  UserCircle, BadgeCheck, Plus, ArrowUpRight, Edit3
} from 'lucide-react';
          ...
          >
            ...
            <div className="mt-4">
              ...
              {user.reports_to_name && (
                <div className="mt-3 inline-flex items-center gap-1.5 px-2 py-1 rounded-lg bg-slate-50 border border-slate-100 text-[11px] text-slate-600 font-medium tracking-tight">
                  <ArrowUpRight className="w-3 h-3 text-slate-400" />
                  Reports to: <span className="text-slate-900 font-bold">{user.reports_to_name}</span>
                </div>
              )}
            </div>
