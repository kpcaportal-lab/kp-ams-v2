  ...
  return (
    <div className="space-y-10 max-w-[1400px] mx-auto pb-20">
      ...
      >
        ...
        <div className="absolute -top-24 -left-24 w-96 h-96 bg-brand-red/5 blur-[120px] rounded-full pointer-events-none -z-10" />
      </motion.header>
      ...
      >
        {kpis.map((kpi, idx) => (
          <motion.div 
            ...
            variants={item}
            className={cn(
              "relative group p-6 rounded-none bg-white border border-slate-200 shadow-none transition-all duration-500 hover:border-brand-navy/30 overflow-hidden"
            )}
          >
            <div className="relative z-10 flex flex-col h-full justify-between">
              <div className="flex items-center justify-between mb-8">
                <div className={cn("p-4 rounded-none transition-transform group-hover:scale-110", kpi.bg)}>
...
function UserProgressCard({ user }: { user: UserWorkProgress }) {
  return (
    <div className="relative overflow-hidden rounded-none bg-white border border-slate-200 shadow-none">
      {/* Card Header */}
      <div className="p-10 border-b border-slate-100 bg-slate-50/30">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-8">
          <div className="flex items-center gap-6">
            <div className="relative group">
              <div className="w-20 h-20 rounded-none bg-brand-navy flex items-center justify-center text-white border border-white/20 shadow-none">
                <Users className="w-10 h-10" strokeWidth={2.5} />
              </div>
              <div className="absolute -bottom-2 -right-2 w-8 h-8 rounded-none bg-white border-4 border-white flex items-center justify-center shadow-none">
                <div className="w-full h-full rounded-none bg-emerald-500" />
              </div>
            </div>
            <div>
      ...
      <div className="p-10">
        ...
        <div className="mb-16">
          ...
          <div className="relative w-full h-8 bg-slate-100 rounded-none border border-slate-200 overflow-hidden shadow-none p-1">
            <motion.div
              initial={{ width: 0 }}
              animate={{ width: `${user.completed_percentage}%` }}
              transition={{ duration: 1.5, ease: "easeOut" }}
              className="relative h-full bg-emerald-500 rounded-none"
            >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-8">
            <div className="flex items-center justify-between pb-4 border-b border-slate-100">
              <div className="flex items-center gap-4">
                <div className="p-3 rounded-none bg-emerald-50 text-emerald-600 border border-emerald-100 shadow-none">
          ...
          <div className="space-y-8">
             <div className="flex items-center justify-between pb-4 border-b border-slate-100">
              <div className="flex items-center gap-4">
                <div className="p-3 rounded-none bg-brand-red/10 text-brand-red border border-brand-red/20 shadow-none">
