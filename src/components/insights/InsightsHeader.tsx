        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
            ...
            <div className="flex items-center gap-3">
                ...
                <button
                    ...
                    className="flex items-center gap-2.5 px-5 py-3.5 bg-white border border-slate-200 rounded-none text-xs font-black text-slate-600 hover:bg-slate-50 transition-all group active:scale-95"
                >
                ...
                <button
                    onClick={onExportPDF}
                    className="flex items-center gap-2.5 px-6 py-3.5 bg-brand-navy text-white rounded-none text-xs font-black hover:bg-slate-800 transition-all group active:scale-95 border-b-2 border-brand-red"
                >
