        ...
        <div className="relative z-10 flex flex-col items-center">
          <div className="relative w-32 h-32 mb-10 flex items-center justify-center">
            ...
            <div className="relative w-24 h-24">
              ...
              <div className="absolute inset-0 border-[6px] border-transparent border-t-brand-red border-r-white/20 rounded-full animate-spin shadow-[0_0_15px_rgba(255,255,255,0.1)]" />
              {/* Pulsing center dot */}
              <div className="absolute inset-[38px] bg-brand-red rounded-full animate-pulse shadow-[0_0_20px_rgba(220,38,38,0.4)]" />
            </div>
          </div>
