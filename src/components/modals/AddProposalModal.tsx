          ...
          >
            ...
            <div className="px-8 py-6 border-b border-slate-100 flex items-center justify-between bg-brand-navy">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h2 className="text-xl font-black text-white tracking-tight">New Proposal</h2>
                  <p className="text-[11px] text-white/60 mt-0.5 font-bold uppercase tracking-widest">K&P Fee Architecture</p>
                </div>
              </div>
              <button
                onClick={() => setOpen(false)}
            ...
            <form onSubmit={handleSubmit} className="p-8 space-y-5">
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  {/* Manager/Lead */}
                  <div className="space-y-1.5">
                    <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest px-1">Project Lead</label>
                    <select
                      required
                ...
                <div className="grid grid-cols-2 gap-4">
                  {/* Proposal Type */}
                  <div className="space-y-1.5">
                    <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest px-1">Proposal Classification</label>
                    <select
                  ...
                  {/* Assignment Type */}
                  <div className="space-y-1.5">
                    <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest px-1">Service Type</label>
                    <select
                ...
                <div className="grid grid-cols-2 gap-4">
                  {/* Quotation Amount */}
                  <div className="space-y-1.5">
                    <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest px-1">Proposed Fees (₹)</label>
                  ...
                  {/* Fiscal Year */}
                  <div className="space-y-1.5">
                    <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest px-1">Financial Year</label>
                    <select
                ...
                {/* Scope Areas */}
                <div className="space-y-1.5">
                  <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest px-1">Service Scope Definition</label>
                  <textarea
                    required
